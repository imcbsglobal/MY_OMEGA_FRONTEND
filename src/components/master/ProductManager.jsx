                  ...
                  <tr key={p.id ?? p.pk} style={styles.tableRow}>
                    ...
                    <td style={{...styles.td,textAlign:'center'}}>
                      {editingId === (p.id ?? p.pk) ? (
                        ...
                        <div style={styles.actionButtons}><button onClick={()=>startEdit(p)} style={styles.editButton}><Edit2 size={14}/> Edit</button><button onClick={()=>handleDelete(p.id ?? p.pk)} style={styles.deleteButton}><Trash2 size={14}/> Delete</button></div>
                      )}
                    </td>
                  </tr>
                ))}
