            ...
            <div style={styles.summaryContent}>
              ...
              <div style={styles.summaryLeft}>
                <div style={styles.detailRow}>
                  ...
                  <span style={styles.detailValue}>{employee.name}</span>
                </div>
                <div style={styles.detailRow}>
                  <span style={styles.detailLabel}>Designation</span>
                  <span style={styles.detailColon}>:</span>
                  <span style={styles.detailValue}>{employee.designation}</span>
                </div>
                <div style={styles.detailRow}>
                  <span style={styles.detailLabel}>Date of Joining</span>
                  <span style={styles.detailColon}>:</span>
                  <span style={styles.detailValue}>{employee.dateOfJoining || '15-03-2020'}</span>
                </div>
                <div style={styles.detailRow}>
                ...
                <div style={styles.detailRow}>
                  ...
                  <span style={styles.detailColon}>:</span>
                  <span style={styles.detailValue}>{employee.payDate || '30/11/2025'}</span>
                </div>
                <div style={styles.detailRow}>
                  <span style={styles.detailLabel}>PF A/C Number</span>
                  <span style={styles.detailColon}>:</span>
                  <span style={styles.detailValue}>{employee.pfNumber || 'AA/AAA/0000000/00/0000000'}</span>
                </div>
                <div style={styles.detailRow}>
                  <span style={styles.detailLabel}>UAN Number</span>
                  <span style={styles.detailColon}>:</span>
                  <span style={styles.detailValue}>{employee.uanNumber || '101010101010'}</span>
                </div>
              </div>
